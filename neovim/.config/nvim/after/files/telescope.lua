...
-- vim.keymap.set('n', '<leader>sr', builtin., { noremap = true })
vim.api.nvim_set_keymap("n", "<Leader>sr", [[<cmd>lua require('telescope').extensions.recent_files.pick()<CR>]], {noremap = true, silent = true})
