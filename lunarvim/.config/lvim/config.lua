...
lvim.keys.normal_mode["<C-p>"] = "<Plug>MarkdownPreviewToggle"
lvim.keys.normal_mode["<C-k>"] = "<C-u>"
lvim.keys.normal_mode["<C-j>"] = "<C-d>"
lvim.keys.normal_mode["<A-1>"] = "winc1w"
lvim.keys.normal_mode["<A-2>"] = "winc3w"
lvim.keys.normal_mode["<A-3>"] = "winc4w"
lvim.keys.normal_mode["<C-j>"] = "<C-d>"
-- Replaced keymappings.lua's <C-w>
-- alternative: enew<bar>bd #<CR>
--  src: https://www.reddit.com/r/neovim/comments/s4jt9n/how_to_close_the_current_buffer_without_closing/hsrepd8/
lvim.keys.normal_mode["<C-S-t>"] = ""
...
vim.api.nvim_set_keymap("n", "gpP", "<cmd>lua require('goto-preview').close_all_win()<CR>", {noremap=true})
...
-- lvim.builtin.telescope.defaults.layout_config.width = 2
